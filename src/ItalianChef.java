...
public class ItalianChef {
    ...
    // - Creating a method to where the italian chef makes a special dish.
    public void makeSpecialDish() {
        System.out.println("The italian chef makes eggplant parm");
    }

    // - Creating a method to where the italian chef makes pasta.
